...
export const chaincode = process.env.CHAINCODE || 'multas';
...
export const identityOrg = process.env.ORG || 'org3';
...
export const couchDBView = process.env.COUCHDBVIEW || 'ch1_multas';
...
export const couchDBPort = process.env.COUCHDB_PORT || 5284;